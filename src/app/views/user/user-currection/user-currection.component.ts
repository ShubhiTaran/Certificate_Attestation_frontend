...
@Component({
  selector: 'app-user-currection',
  templateUrl: './user-currection.component.html',
  styleUrls: ['./user-currection.component.scss']
})
export class UserCurrectionComponent implements OnInit {
  ...
  certificate_no: any;
  universitys: any;
  certificate_remark: any;
  years: any

  affidavit_photo_remark: any
  callletter_photo_remark: any
  visa_photo_remark: any
  certificate_photo_remark: any
  ...
  ngOnInit() {
    ...
    this.certificate_remark = this.route.snapshot.queryParamMap.get('certificate_remark')
    this.passport_remark = this.route.snapshot.queryParamMap.get('passport_remark')
  ...
  showData() {
    let sendData = { "application_no": this.application_id };
    console.log('sendData', sendData)
    this.userservice.requestDetail(sendData)
      .subscribe((result) => {
        let status = null
        ...
        if (this.userservice.home(status)) {
          console.log('requestDetail', result)
          ...
          this.affidavit_photo_remark = data['affidavit_photo_remark']
          this.visa_photo_remark = data['visa_photo_remark']
          this.callletter_photo_remark = data['callletter_photo_remark']
          this.certificate_photo_remark = data['certificate_photo_remark']
  ...
  sepetateImg(data) {
    let retData = []
    let certificate_photo_remark = this.certificate_photo_remark
    if (!certificate_photo_remark) {
      certificate_photo_remark = Array(data.length).fill(null)
    }
    data.map((obj, index) => {
      ...
      retData.push({
        certificate_photo_remark: certificate_photo_remark[index],
        certificate_no,
        certificate_photo,
  ...
  remark() {
    ...
    let sendData = {
      ...
      affidavit_photo_remark: this.affidavit_photo_remark,
      callletter_photo_remark: this.callletter_photo_remark,
      visa_photo_remark: this.visa_photo_remark,
      certificate_photo_remark: this.certificate_photo_remark,
    }
  ...
  onSubmit() {
    ...
    let chk = false
    console.log('certificate_photo_remark', this.certificate_photo_remark)

    try{
    this.certificate_photo_remark.map((value) => {
      if (value) {
        chk = true
      }
    })
    ...
    if (this.affidavit_photo_remark ||
      this.callletter_photo_remark ||
      this.affidavit_photo_remark) {
      chk = true
    }

    if (chk) {
      let message = 'Please remove remark by delete the images.'
      Swal.fire('', message)
      return
    }
  ...
  goToPassport() {
    this.router.navigate(['user-currection-passport'],
      {
        queryParams: {
          application_no: this.application_id, certificate_remark: this.certificate_remark,
  ...
  popUpModel(content, img, imgName, certificate_no, index) {
  ...
  back() {
    this.router.navigate(['user-current-designation'],
      { queryParams: { application_no: this.application_id, _id: this._id, "userName": this.userName } });
  }
  ...
  deleteDocument() {
    ...
    console.log('certificate_no', this.certificate_no)
    ...
    if (this.certificate_no == 'deleteVisaImage') {
      ...
      this.userservice.deleteDocument(data).subscribe(data => {
        ...
        console.log('status', status);
        if (this.userservice.home(status)) {
          this.certificate_photo_remark[this.remarkIndex] = null
  ...
  deleteCallLetterImage(application_no) {
    ...
    this.userservice.deleteCallLetterImage({ application_no }).subscribe(data => {
      ...
      if (this.userservice.home(status)) {
        console.log('data', data)
        this.callletter_photo_remark = null
        this.remark()
  ...
  deleteAffidavitImage(application_no) {
    this.userservice.deleteAffidavitImage({ application_no }).subscribe(data => {
      ...
      if (this.userservice.home(status)) {
        console.log('data', data)
        this.affidavit_photo_remark = null
        this.remark()
